...
namespace mygame
{
    ...
    public class Item
    {
        ...
        public static Item CreateWeapon(int itemLevel)
        {
            ...
            {
                if (ItemManager.instance.itemDictionary[i].ItemLevel==itemLevel&&(ItemManager.instance.itemDictionary[i].type==ItemType.pistol|| ItemManager.instance.itemDictionary[i].type == ItemType.shotgun|| ItemManager.instance.itemDictionary[i].type == ItemType.assaultRifle|| ItemManager.instance.itemDictionary[i].type == ItemType.sniperRifle))
                {
        ...
        public static Item CreateRing(int itemLevel)
        {
            ...
            for (int i = 0; i < ItemManager.instance.itemDictionary.Count; i++)
            {
                if (ItemManager.instance.itemDictionary[i].ItemLevel == itemLevel && (ItemManager.instance.itemDictionary[i].type == ItemType.ring))
                {
        ...
        public static Item CreateArmor(int itemLevel)
        {
            ...
            for (int i = 0; i < ItemManager.instance.itemDictionary.Count; i++)
            {
                if (ItemManager.instance.itemDictionary[i].ItemLevel == itemLevel && (ItemManager.instance.itemDictionary[i].type == ItemType.armor))
                {
